...
// UI_KEYS_BUTTON_LOW(UI_ENCODER_A,UI_ACTION_NEXT); // push button, connects gnd to pin
// UI_KEYS_BUTTON_LOW(UI_ENCODER_B,UI_ACTION_PREVIOUS); // push button, connects gnd to pin
